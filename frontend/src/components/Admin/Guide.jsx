...
import Pagination from "../Guide/Pagination";
import EditGuideModal from "../Guide/EditGuideModal";
import ViewGuideModal from "../Guide/ViewGuideModal";
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex border-b border-gray-700 mb-6 overflow-x-auto scrollbar-thin">
          <button
            onClick={() => handleTabChange("guides")}
            className={`flex items-center gap-2 px-4 py-3 font-medium transition-colors whitespace-nowrap ${activeTab === "guides"
                ? "text-yellow-400 border-b-2 border-yellow-400"
                : "text-gray-400 hover:text-white"
              }`}
          >
          ...
          <button
            onClick={() => handleTabChange("students")}
            className={`flex items-center gap-2 px-4 py-3 font-medium transition-colors whitespace-nowrap ${activeTab === "students"
                ? "text-yellow-400 border-b-2 border-yellow-400"
                : "text-gray-400 hover:text-white"
              }`}
          >
                ...
                {loading ? (
                  ...
                  currentItems.map((person) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`px-3 py-1 text-sm font-medium rounded ${person.role === "guide"
                              ? "bg-green-600 text-white"
                              : "bg-blue-600 text-white"
                            }`}
                        >
