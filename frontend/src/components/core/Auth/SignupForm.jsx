...
function SignupFormTemplate() {
  ...
  const handleOnSubmit = (e) => {
    ...
    // College is hardcoded, no check needed
          ...
          <div className="w-full lg:w-1/2 max-w-lg mx-auto lg:mx-0">
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8 shadow-2xl">
              <h1 className="text-3xl font-bold text-white mb-2 text-center lg:text-left">
                Join the <span className="text-vjti-gold">VJTI Community</span>
              </h1>
              <p className="text-richblack-300 mb-8 text-center lg:text-left">
                Start your{" "}
                <span className="text-vjti-accent font-semibold italic">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-richblack-300 mb-1">
                    College/University <span className="text-vjti-accent">*</span>
                  </label>
                  <input
                    type="text"
                    name="college"
                    value={college}
                    readOnly
                    className="w-full px-3 py-2 bg-richblack-800 border border-richblack-600 rounded-md text-richblack-50 opacity-80 cursor-not-allowed focus:outline-none"
                  />
                </div>
                ...
                <button
                  ...
                  onClick={handleOnSubmit}
                  disabled={loading}
                  className={`w-full font-semibold py-2 px-4 rounded-md transition-all duration-200 mt-6 ${loading
